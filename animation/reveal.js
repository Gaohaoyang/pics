...
!(function (e, t) {
      ...
      if (e) {
        var t = function (e) {
          ...
          g = function (e) {
            return (
              e.dirty !== s ||
              (e.dirty === s && e.element.parentNode.clientWidth !== e.availableWidth)
            )
          },
          v = function (t) {
  ...
  class P {
    ...
    getAutoAnimateOptions(t, i) {
      ...
      return (
        ...
        t.dataset.autoAnimateDuration && (n.duration = parseFloat(t.dataset.autoAnimateDuration)),
        t.dataset.autoAnimateDelay && (n.delay = parseFloat(t.dataset.autoAnimateDelay)),
        n
      )
    }
  ...
  class T {
    ...
    getHash(e) {
      ...
      if (
        (this.Reveal.getConfig().fragmentInURL || (s.f = void 0), 'string' == typeof n && n.length)
      )
        (t = '/' + n), s.f >= 0 && (t += '/' + s.f)
      else {
  ...
  function Y(a, l) {
    ...
    function Ee() {
      Y.slides.classList.add('no-transition'),
        g ? Y.wrapper.classList.add('no-hover') : Y.wrapper.classList.remove('no-hover'),
        se.render(),
        te.render(),
        ie.render(),
        de.render(),
        ...
        (Y.pauseOverlay = r(
          ...
          'div',
          'pause-overlay',
          E.controls ? '<button class="resume-button">Resume presentation</button>' : null
        )),
        (Y.statusElement = Re()),
    ...
    function xe(t) {
      ...
      Y.wrapper.classList.remove(n.transition),
        ...
        Y.wrapper.setAttribute('data-background-transition', E.backgroundTransition),
        ...
        s > 1 &&
          ...
          ((f = new V(Y.wrapper, () => Math.min(Math.max((Date.now() - Q) / J, 0), 1))),
          f.on('click', Yt),
          (Z = !1)),
    ...
    function Pe() {
      window.addEventListener('resize', Kt, !1),
        ...
        E.focusBodyOnPageVisibilityChange && document.addEventListener('visibilitychange', Vt, !1)
    }
    function Ne() {
      pe.unbind(),
        ve.unbind(),
    ...
    function De(e) {
      'string' == typeof e.layout && (j.layout = e.layout),
        ...
        j.layout ? s(Y.slides, j.layout + ' ' + j.overview) : s(Y.slides, j.overview)
    }
      ...
      if (Y.wrapper && !ge.isPrintingPDF()) {
        if (!E.disableLayout) {
          ...
          Ke(E.width, E.height),
            ...
            (U = Math.min(e.presentationWidth / e.width, e.presentationHeight / e.height)),
    ...
    function at(e, t, i, n) {
      ...
      void 0 !== t || oe.isActive() || (t = Xe(s[e])),
        p && p.parentNode && p.parentNode.classList.contains('stack') && $e(p.parentNode, v)
      const a = H.concat()
      H.length = 0
      let o = u || 0,
        r = v || 0
    ...
    function Bt({ skipFragments: e = !1 } = {}) {
      if (e || !1 === ae.prev())
        if (vt().up)
          ...
          let i
          if (
            ((i = E.rtl ? t(Y.wrapper, A + '.future').pop() : t(Y.wrapper, A + '.past').pop()),
    ...
    function Ot({ skipFragments: e = !1 } = {}) {
      if (
        ((x.hasNavigatedHorizontally = !0), (x.hasNavigatedVertically = !0), e || !1 === ae.next())
      ) {
        let t = vt()
